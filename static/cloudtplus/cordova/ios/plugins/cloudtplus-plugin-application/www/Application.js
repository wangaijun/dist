cordova.define("cloudtplus-plugin-application.Application", function(require, exports, module) {
	...
	var CHECK = {
        ...
        EnumTaskCategory: {type: "Enum", enum: ["quality", "security"]},
        EnumMarkBlueprintMode: {type: "Enum", enum: ["new", "view", "move"]},
        EnumPrintItemType: {type: "Enum", enum: ["TEXT", "TITLE_VALUE", "NEW_LINE", "SEPERATOR_LINE", "BAR_CODE", "QR_CODE", "IMAGE"]},
     ...
     *  显示聊天输入框
     */
    applicationExport.showChatInputView = function(successCallback, errorCallback, options) {
        options = options || {};
        var opts = {
        ...
        var err = checkOptions("showChatInputView", opts, {
        ...
        if (err) {
               ...
               return exec(successCallback, errorCallback, "Application", "showChatInputView", [opts]);
        }
    };
	 ...
	 *  隐藏聊天输入框
	 */
	applicationExport.hideChatInputView = function(successCallback, errorCallback) {
		return exec(successCallback, errorCallback, "Application", "hideChatInputView", []);
	};
    ...
    applicationExport.downloadFile = function(successCallback, errorCallback, progressCallback, options) {
        ...
        if (err) {
           ...
           }, errorCallback, "Application", "downloadFile", [opts.url, opts.headers]);
        }
    };
    ...
    applicationExport.markOnBlueprint = function(successCallback, errorCallback, options) {
        ...
        var err = checkOptions("markOnBlueprint", opts, {
                               category: CHECK.EnumTaskCategory,
                               mode: CHECK.EnumMarkBlueprintMode,
     ...
     * @return {Object} 返回cloudtplus对象
     */
    applicationExport.createQSProblem = function(successCallback, errorCallback, options) {
        options = options || {};
        var opts = {
            category: options.category || "quality",
        ...
        opts = removeInvalidProperty(opts);
        var err = checkOptions("createQSProblem", opts, {
                               category: CHECK.EnumTaskCategory,
                               blueprints: CHECK.ObjectArrayAllowEmpty
                               });
        if (err) {
           errorCallback && errorCallback.call(this, err);
        } else {
           return exec(successCallback, errorCallback, "Application", "createQSProblem", [opts.category, opts.blueprints]);
        }
    };
	 ...
	 *  退出页面
	 */
	applicationExport.exitApp = function(successCallback, errorCallback) {
		return exec(successCallback, errorCallback, "Application", "exitApp", []);
	};
	 ...
	 *  @param {String} watermark 照片上的水印文字
     *  @param {String} waterColor 水印文字颜色，默认值: #FFFFFF
     *  @param {Number} cropRate 照片剪裁框宽高比，默认为0，表示不剪裁；值为1则剪裁框为正方形，值越大则剪裁框越扁平
	...
	applicationExport.getOfflinePicture = function(successCallback, errorCallback, options) {
		...
		var updateFile = function(successCallback, errorCallback, emptyFn, imageUrl, opts) {
			var items = [];
				...
				return function(imageUrl) {
					if (imageUrl && imageUrl.length > 0) {
						if (options.isTemp) {
							...
							updateFile(successCallback, errorCallback, emptyFn, imageUrl, opts);
						}
					} else {
     ...
     *  @param {String} gcloudUploadUrl 广联云上传地址，不为空时，表示该文件要上传到广联云
	 ...
	 *  @param {String} thumbUrl 缩略图，空字符串表示没有图标，"appIcon"（应用图标）, "applicationIcon"（云建造图标）, "file:///", "https://"
   ...
   applicationExport.currentLocation = function(successCallback, errorCallback, options) {
    ...
    applicationExport.initBluetooth = function(successCallback, errorCallback, options) {
        options = options || {};
        return exec(successCallback, errorCallback, "Application", "initBluetooth", [options]);
    };
